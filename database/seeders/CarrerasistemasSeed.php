...
class CarrerasistemasSeed extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        DB::table('unis')->insert([
            'name' => 'Centro Univerisario regional del Litoral Pacífico',
            'address' => 'Km 156.5 carretera a San Carlos, Choluteca, Honduras',
            'logo' => '/storage/imagenes/WSSF4MV6LZdpwGPPrBaIPrh0bffRcvFBTmL1uZIk',
            'status' => '1',
            'shortname' => 'CURLP',
        ]);
        ...
        DB::table('carreras')->insert([
            ...
            'shortname' => 'IS',
            'status' => '1',
            'logo' => '/storage/imagenes/YFldatIwtHfwxSLeWEsxVLMSbqsAvcUjfDS1LR3D',
            'description' => ' ',
            'color1' => '#000000',
            'color2' => '#000000',
            'color3' => '#000000',
        ...
        // crear la realcion unihascarrera
        DB::table('unihascarreras')->insert([
            'university_id' => '1',
            'career_id' => '1',
        ]);
