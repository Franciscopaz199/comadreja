            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item">
                            <a href="{{ url('/jefesdepartamentos') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Jefesdepartamentos</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/clases') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Clases</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/unihascarreras') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Unihascarreras</a> 
                        </li>
						<li class="nav-item">
						...
						<li class="nav-item">
                            <a href="{{ url('/facultades') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Facultades</a> 
                        </li>
						<li class="nav-item">
                            <a href="{{ url('/unis') }}" class="nav-link"><i class="fab fa-laravel text-info"></i> Unis</a> 
                        </li>
